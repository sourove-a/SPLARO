...
const AdminCampaignTopNav: React.FC = () => {
  return (
    <div className="flex items-center justify-between mb-8 gap-4">
      <div className="flex items-center gap-3 text-[#D4B47A] text-[10px] uppercase tracking-[0.35em] font-black">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="space-y-2">
                    <button className="text-left" onClick={() => navigate(`/admin/campaigns/${campaign.id}`)}>
                      <h3 className="text-xl font-black text-white uppercase tracking-tight hover:text-white/90 transition-colors">{campaign.name}</h3>
                    </button>
      ...
      <div className="min-h-screen pt-36 pb-20 px-6 max-w-6xl mx-auto">
        ...
        <GlassCard className="p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="space-y-3">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-white/90">Users</h3>
