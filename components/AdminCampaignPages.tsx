...
const statusChip = (status: CampaignStatus) => {
  ...
  if (status === 'Paused') return 'bg-blue-500/10 text-blue-400 border-blue-500/20';
...
const AdminCampaignTopNav: React.FC = () => {
  return (
    <div className="flex items-center justify-between mb-8 gap-4">
      <div className="flex items-center gap-3 text-blue-400 text-[10px] uppercase tracking-[0.35em] font-black">
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="space-y-2">
                    <button className="text-left" onClick={() => navigate(`/admin/campaigns/${campaign.id}`)}>
                      <h3 className="text-xl font-black text-white uppercase tracking-tight hover:text-blue-300 transition-colors">{campaign.name}</h3>
                    </button>
                ...
                <div className="flex flex-wrap gap-3">
                  {campaign.status !== 'Active' ? (
                    <button
                      ...
                      className="px-4 py-2 rounded-full border border-blue-500/30 text-blue-300 text-[10px] uppercase tracking-[0.2em] font-black hover:bg-blue-500/10 transition-all disabled:opacity-40"
                    >
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full border border-blue-500/30 text-blue-300 text-[10px] uppercase tracking-[0.2em] font-black hover:bg-blue-500/10 transition-all"
                  >
                    View logs
                  </button>
                </div>
        ...
        <GlassCard className="p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 rounded-2xl border border-blue-500/20 bg-blue-500/5">
              <p className="text-[10px] uppercase tracking-[0.25em] text-blue-400 font-black">Target count</p>
    ...
    <AdminGate>
      <div className="min-h-screen pt-36 pb-20 px-6 max-w-5xl mx-auto">
        ...
        <GlassCard className="p-10 space-y-8">
          ...
          {sending && (
            <div className="p-5 rounded-2xl border border-blue-500/20 bg-blue-500/5">
              <p className="text-[10px] uppercase tracking-[0.2em] text-blue-300 font-black mb-3">Sending in progress</p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="px-6 py-3 rounded-full border border-blue-500/30 text-blue-300 text-[10px] uppercase tracking-[0.2em] font-black hover:bg-blue-500/10 transition-all"
            >
      ...
      <div className="min-h-screen pt-36 pb-20 px-6 max-w-6xl mx-auto">
        ...
        <GlassCard className="p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-black uppercase tracking-[0.2em] text-blue-300">Jobs</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-black uppercase tracking-[0.2em] text-blue-300">Delivery</h3>
              ...
              <div className="max-h-[560px] overflow-auto space-y-3 pr-1">
                {logs.map((log) => (
                  <div key={log.id} className="p-4 border border-white/10 rounded-2xl bg-white/[0.02]">
                    ...
                    <p className="text-[10px] uppercase tracking-[0.2em] text-blue-300 mt-2">{log.status}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="min-h-screen pt-36 pb-20 px-6 max-w-6xl mx-auto">
        ...
        <GlassCard className="p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="space-y-3">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-blue-300">Users</h3>
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-blue-300">Orders</h3>
              {results.orders.length === 0 && <div className="p-4 border border-white/10 rounded-xl text-zinc-500 text-sm">No orders</div>}
              {results.orders.map((order) => (
                <Link key={order.id} to="/admin_dashboard?tab=orders" className="block p-4 border border-white/10 rounded-xl bg-white/[0.02] hover:border-blue-500/30 transition-all">
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-black uppercase tracking-[0.2em] text-blue-300">Campaigns</h3>
              ...
              {results.campaigns.map((campaign) => (
                <Link key={campaign.id} to={`/admin/campaigns/${campaign.id}`} className="block p-4 border border-white/10 rounded-xl bg-white/[0.02] hover:border-blue-500/30 transition-all">
