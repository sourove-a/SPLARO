          ...
          {isHovered && !isTouchDevice && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-20 px-6 backdrop-blur-[2px]">
              <motion.button
                ...
                className="w-full h-14 bg-white/10 backdrop-blur-3xl border border-white/20 rounded-2xl flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] text-white hover:bg-amber-500/20 hover:text-white transition-all duration-500"
              >
                ...
                <motion.button
                  ...
                  className={`h-14 rounded-2xl flex items-center justify-center gap-3 text-[9px] font-black uppercase tracking-[0.1em] transition-all duration-500 ${
                    urgency.outOfStock
                      ...
                      : 'bg-white/12 border border-white/25 text-white shadow-xl hover:bg-amber-500/25'
                  }`}
                >
                  Buy Now
                </motion.button>
      ...
      <div className="px-1 sm:px-2">
        <div className="flex justify-between items-start gap-4">
          <div className="flex-1">
            <button
              ...
              className="text-[8px] font-black text-amber-500 uppercase tracking-[0.5em] mb-2 block group-hover:translate-x-1 transition-transform hover:text-amber-300"
            >
              {product.brand}
            </button>
            <h3 className="text-sm sm:text-lg md:text-2xl font-black text-white leading-tight uppercase italic tracking-tighter group-hover:text-amber-400 transition-colors">
              {product.name}
            </h3>
            <div className="mt-3 flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center px-2.5 py-1 rounded-full border border-white/15 bg-white/[0.03] text-[8px] font-black uppercase tracking-[0.14em] text-white/75 hover:border-amber-500/45 hover:text-amber-300"
              >
                {product.category}
              </button>
              {product.subCategory && (
                <button
                  ...
                  className="inline-flex items-center px-2.5 py-1 rounded-full border border-white/10 bg-white/[0.02] text-[8px] font-black uppercase tracking-[0.14em] text-zinc-300 hover:border-amber-500/35 hover:text-amber-300"
                >
                  {product.subCategory}
                </button>
              )}
                  ...
                  <span
                    className={`inline-flex items-center px-2.5 py-1 rounded-full border text-[8px] font-black uppercase tracking-[0.14em] ${
                      urgency.outOfStock
                        ...
                        : 'border-amber-500/35 bg-amber-600/10 text-amber-300'
                    }`}
                  >
                    {urgency.outOfStock
          ...
          <div className="text-right">
            <p className="text-sm sm:text-lg md:text-xl font-black text-white group-hover:text-amber-400 transition-colors">৳{product.price.toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center gap-3 opacity-30 group-hover:opacity-60 transition-opacity">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[7px] font-black text-amber-500 uppercase tracking-[0.4em]">Delivery: 7-10 Days</span>
          </div>
        </div>
