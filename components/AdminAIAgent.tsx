  ...
  return (
    <div className="flex h-[calc(100vh-120px)] gap-6 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <GlassCard className="flex-1 overflow-y-auto p-6 flex flex-col gap-4 min-h-0">
          ...
          {isLoading && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-3">
              ...
              <div className="px-5 py-4 rounded-2xl" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        {/* Input Area */}
        <div
          className="mt-4 flex gap-3 items-end p-4 rounded-2xl"
