      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 lg:gap-16">
        ...
        <div className="lg:col-span-8">
          <header className="mb-8 sm:mb-12">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter uppercase italic leading-[0.9] mb-4">Your<br /><span className="text-amber-500">Cart.</span></h1>
              ...
              <GlassCard key={item.cartId} className="p-4 sm:p-6 group">
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    <span className="text-amber-500 text-[10px] font-black uppercase tracking-[0.3em] mb-2 block">{item.product.brand}</span>
                  ...
                  <div className="w-full sm:w-auto flex flex-col items-center sm:items-end gap-3">
                    <div className="h-11 w-full sm:w-auto rounded-xl border border-white/15 bg-black/25 px-2 flex items-center gap-2">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 rounded-lg border border-white/10 text-white/85 hover:text-amber-300"
          ...
          <div className="sticky top-24 sm:top-32">
            <GlassCard className="p-5 sm:p-8 border border-white/10">
              ...
              <PrimaryButton
                ...
                className="w-full min-h-14 h-14 sm:h-16 text-[10px] shadow-[0_0_35px_rgba(196, 146, 58,0.25)] hover:shadow-[0_0_60px_rgba(196, 146, 58,0.45)]"
              >
              ...
              <div className="mt-10 flex flex-col gap-4">
                <div className="flex items-center gap-4 text-[9px] font-black uppercase tracking-widest text-white/40">
                  <ShieldCheck className="w-4 h-4 text-amber-500" /> Secure Checkout Protocol
                </div>
                <div className="flex items-center gap-4 text-[9px] font-black uppercase tracking-widest text-white/40">
                  <HelpCircle className="w-4 h-4 text-amber-500" /> Elite Customer Support
                </div>
              </div>
            </GlassCard>
          </div>
