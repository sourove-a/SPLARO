      ...
      <div className="rounded-[14px] border border-white/10 bg-[#0A0C12]/80 p-6 md:p-8">
        ...
        <div className="flex flex-wrap gap-2 mt-5">
          <button
            ...
            onClick={runPreview}
            className="h-11 px-4 rounded-xl border border-blue-400/35 text-white/90 disabled:opacity-60 inline-flex items-center gap-2"
          >
        ...
        {toast && <p className="mt-3 text-[11px] text-white/90">{toast}</p>}
      </div>
