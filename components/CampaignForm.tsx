      ...
      <div className="rounded-[26px] border border-white/10 bg-[#0A0C12]/80 p-6 md:p-8">
        ...
        <div className="flex flex-wrap gap-2 mt-5">
          <button
            ...
            onClick={runPreview}
            className="h-11 px-4 rounded-xl border border-blue-400/35 text-blue-300 disabled:opacity-60 inline-flex items-center gap-2"
          >
          ...
          <button
            ...
            className="h-11 px-4 rounded-xl bg-blue-500 text-black font-black disabled:opacity-60 inline-flex items-center gap-2"
          >
        ...
        {preview && (
          <div className="mt-4 rounded-xl border border-blue-500/25 bg-blue-500/10 p-4">
            <p className="text-[11px] uppercase tracking-[0.2em] text-blue-300 font-black">Preview</p>
        ...
        {toast && <p className="mt-3 text-[11px] text-blue-300">{toast}</p>}
      </div>
                ...
                <div key={campaign.id} className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="h-8 px-3 rounded-lg border border-blue-500/35 text-[10px] text-blue-300 disabled:opacity-60"
                    >
                      Send Now
                    </button>
                  </div>
