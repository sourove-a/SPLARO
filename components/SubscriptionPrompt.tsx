  ...
  return (
    <div className="fixed left-4 right-4 bottom-24 sm:bottom-28 z-[650] mx-auto max-w-lg rounded-2xl border border-white/15 bg-[#05070e]/95 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.45)] p-4">
      <div className="flex items-start gap-3">
        <div className="w-11 h-11 rounded-xl border border-green-500/30 bg-green-500/10 text-green-300 flex items-center justify-center shrink-0">
          <Bell className="w-5 h-5" />
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-[10px] font-black uppercase tracking-[0.22em] text-green-400">Stay Updated</p>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              disabled={busy}
              className="h-10 px-4 rounded-xl bg-green-500 text-black text-[10px] font-black uppercase tracking-[0.2em] disabled:opacity-60"
            >
