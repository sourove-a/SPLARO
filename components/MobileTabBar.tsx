  ...
  return (
    ...
    >
      <div className="max-w-screen-sm mx-auto relative" style={{ height: 'var(--mobile-nav-height)' }}>
              ...
              >
                <div className="relative p-1.5">
                  <item.icon
                    className={`w-7 h-7 transition-all duration-500 ${isActive
                      ? 'text-blue-300 scale-110 drop-shadow-[0_0_12px_rgba(96, 165, 250,0.75)]'
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute bottom-1.5 w-8 h-1 rounded-full bg-blue-400 shadow-[0_0_10px_rgba(96, 165, 250,0.65)]"
        ...
        <div className="absolute inset-x-10 bottom-0 h-3 bg-blue-500/10 blur-xl rounded-full -z-10" />
      </div>
    </motion.div>
  );
};
