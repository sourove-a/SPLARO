      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {floatingAssets.map((asset, i) => (
          <motion.div
            ...
            className="absolute w-[160px] h-[160px] border border-green-500/10 rounded-full blur-sm"
            style={{
              top: asset.top,
              left: asset.left,
            }}
      ...
      >
        <GlassCard className="p-8 md:p-12 !border-white/10 !bg-white/[0.08] shadow-[0_0_80px_rgba(0,0,0,0.8)] !rounded-[48px] backdrop-blur-[120px] relative overflow-hidden group">
          ...
          <header className="flex flex-col items-center text-center mb-12 relative z-10 pt-4">
            ...
            <div className="h-1 w-16 bg-green-500 mb-6 shadow-[0_0_20px_#00D4FF]" />
            <p className="text-[10px] font-black uppercase tracking-[0.6em] text-green-500 opacity-60">
            ...
            {authMode !== 'forgot' && (
              <div className="mt-6 grid grid-cols-2 gap-2 w-full max-w-xs p-1 rounded-full border border-white/10 bg-white/5">
                ...
                <button
                  ...
                  className={`h-10 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${authMode === 'signup' ? 'bg-green-500/70 border border-green-300/50 text-white' : 'text-white/50 hover:text-white'}`}
                >
                  Sign Up
                </button>
              </div>
                ...
                {authMode === 'login' && !emailVerificationPending && (
                  <div className="flex justify-end mt-[-1rem]">
                    <button
                      ...
                      className="text-[10px] font-black uppercase text-green-400/80 hover:text-green-300 tracking-widest transition-colors"
                    >
                      Forgot Password?
                    </button>
                  </div>
          ...
          <div className="mt-8 flex justify-center">
            {googleClientId ? (
              ...
              <div className="w-full max-w-sm h-12 rounded-full border border-green-400/30 bg-green-500/10 text-[10px] font-semibold tracking-wide text-green-100 flex items-center justify-center px-4 text-center">
          ...
          <footer className="mt-10 text-center">
            <p className="text-xs text-white/40 font-medium">
              ...
              <button
                ...
                className="text-green-500 font-black uppercase tracking-widest text-[10px] ml-2 hover:underline"
              >
