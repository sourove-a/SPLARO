...
import { getSubscriptionsList } from '@/lib/adminService';
...
export async function GET(request: Request) {
  ...
  const ctx = buildRequestContext('/api/admin/subscriptions', requestId);
  ...
  try {
    ...
    const result = await getSubscriptionsList(parsed.data);
    ...
    logError('admin_subscriptions_failed', {
      requestId,
      endpoint: '/api/admin/subscriptions',
