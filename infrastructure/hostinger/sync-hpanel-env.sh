...
for key in \
  ...
  JWT_SECRET JWT_REFRESH_SECRET ADMIN_SESSION_SECRET ENCRYPTION_KEY ENCRYPTION_KEY_PREVIOUS \
  ...
  NEXT_PUBLIC_GA_MEASUREMENT_ID GA4_MEASUREMENT_ID NEXT_PUBLIC_GA_ID NEXT_PUBLIC_FB_PIXEL_ID \
