...
define('GOOGLE_SHEETS_TIMEOUT_SECONDS', splaro_env_int('GOOGLE_SHEETS_TIMEOUT_SECONDS', 12, 2, 30));
define('GOOGLE_SHEETS_CIRCUIT_BREAK_SECONDS', splaro_env_int('GOOGLE_SHEETS_CIRCUIT_BREAK_SECONDS', 600, 30, 3600));
define('SHEETS_SHUTDOWN_DRAIN_ENABLED', splaro_env_bool('SHEETS_SHUTDOWN_DRAIN_ENABLED', false));
define('SHEETS_SHUTDOWN_DRAIN_LIMIT', splaro_env_int('SHEETS_SHUTDOWN_DRAIN_LIMIT', 1, 1, 3));
define('SHUTDOWN_CAMPAIGN_DRAIN_LIMIT', splaro_env_int('SHUTDOWN_CAMPAIGN_DRAIN_LIMIT', 1, 1, 5));
define('SHUTDOWN_PUSH_DRAIN_LIMIT', splaro_env_int('SHUTDOWN_PUSH_DRAIN_LIMIT', 3, 1, 20));
...
define('HEALTH_QUEUE_RETRY_WARN_THRESHOLD', splaro_env_int('HEALTH_QUEUE_RETRY_WARN_THRESHOLD', 3, 1, 1000));
define('HEALTH_SHEETS_RETRY_WARN_THRESHOLD', splaro_env_int('HEALTH_SHEETS_RETRY_WARN_THRESHOLD', 2, 1, 1000));
...
define('HEALTH_AUTO_RECOVERY_ENABLED', splaro_env_bool('HEALTH_AUTO_RECOVERY_ENABLED', true));
