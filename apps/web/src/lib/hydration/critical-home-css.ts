...
@media (prefers-reduced-motion:reduce){html[data-os=windows] .home-flow-strip__track{animation:home-flow-marquee 36s linear infinite!important;animation-duration:36s!important}}
