...
const ORDER_STATUS_FLOW: Record<OrderStatus, OrderStatus[]> = {
  ...
  // Allow pack after early courier booking (scan-to-pack station workflow)
  COURIER_BOOKED: ['PACKED', 'PICKED_UP', 'IN_TRANSIT', 'OUT_FOR_DELIVERY', 'SHIPPED', 'DELIVERED', 'RETURNED', 'CANCELLED'],
