...
export function buildApiRouteProbes(storeId = 'splaro'): ApiRouteProbe[] {
  ...
  return [
    ...
    p('finance-overview', 'Finance Overview V1', 'Partners', q('/admin/finance/overview') + '&preset=today'),
    p('finance-order-profit', 'Order Profitability', 'Partners', q('/admin/finance/orders') + '&preset=30d&limit=5'),
    p('finance-settings', 'Finance Settings', 'Partners', q('/admin/finance/settings')),
