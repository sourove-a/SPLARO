    ...
    try {
      if (provider === 'bkash') {
        ...
        const params = new URLSearchParams({
          ...
          success_url: 'https://splaro.com.bd/payment/success',
          fail_url: 'https://splaro.com.bd/payment/failed',
          cancel_url: 'https://splaro.com.bd/payment/cancel',
          cus_name: 'SPLARO Test',
          cus_email: 'test@splaro.com.bd',
