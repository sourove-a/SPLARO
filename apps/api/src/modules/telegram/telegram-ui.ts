...
export function inlineInventoryMenu(): InlineKeyboardMarkup {
  return {
    inline_keyboard: [
      ...
      [
        { text: 'Product Code Lookup', callback_data: TG_CALLBACK.INVENTORY_LOOKUP_HELP },
...
export function menuMessage(): string {
  return tgJoin(
    ...
    `<b>Commands</b>\n${tgCard([
      ...
      '<code>/stock 895765</code> — stock by Product Code or SKU',
...
export const BOT_COMMANDS: BotCommand[] = [
  ...
  { command: 'stock', description: 'Stock by Product Code or SKU' },
  { command: 'code', description: 'Stock by Product Code' },
