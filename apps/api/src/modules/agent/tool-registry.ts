...
const TIER_BY_NAME: Record<string, ToolTier> = {
  ...
  audit_high_risk_orders: 'READ',
  get_profit_insights: 'READ',
  verify_customer_reputation: 'READ',
  track_courier_consignment: 'READ',
  search_catalog_and_orders: 'READ',
  recover_abandoned_checkouts: 'READ',
  segment_vip_customers: 'READ',
  forecast_inventory_restock: 'READ',
  create_product_draft: 'WRITE',
  update_product: 'WRITE',
  send_telegram_message: 'WRITE',
  generate_reorder_purchase_order: 'WRITE',
  moderate_and_reply_reviews: 'WRITE',
  generate_executive_daily_brief: 'WRITE',
  create_discount_coupon: 'WRITE',
  log_business_expense: 'WRITE',
  update_order_status: 'DANGEROUS',
  book_order_courier: 'DANGEROUS',
  book_all_pending_courier: 'DANGEROUS',
...
const CATEGORY_BY_NAME: Record<string, ToolCategory> = {
  ...
  get_profit_insights: 'analytics',
  generate_executive_daily_brief: 'analytics',
  search_catalog_and_orders: 'analytics',
  recover_abandoned_checkouts: 'analytics',
  segment_vip_customers: 'analytics',
  log_business_expense: 'analytics',
  get_order_list: 'orders',
  get_order_detail: 'orders',
  get_orders_by_phone: 'orders',
  update_order_status: 'orders',
  book_order_courier: 'orders',
  book_all_pending_courier: 'orders',
  audit_high_risk_orders: 'orders',
  verify_customer_reputation: 'orders',
  track_courier_consignment: 'orders',
  get_low_stock_products: 'inventory',
  generate_reorder_purchase_order: 'inventory',
  forecast_inventory_restock: 'inventory',
  get_seo_gaps: 'seo',
  fix_missing_seo_meta: 'seo',
  analyze_product_seo: 'seo',
  create_product_draft: 'products',
  update_product: 'products',
  moderate_and_reply_reviews: 'products',
  create_discount_coupon: 'products',
