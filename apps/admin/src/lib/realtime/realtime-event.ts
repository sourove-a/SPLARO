export type AdminRealtimeOrderEvent = {
...
export function parseAdminRealtimeOrderEvent(raw: unknown): AdminRealtimeOrderEvent | null {
  ...
  const event: AdminRealtimeOrderEvent = {
    type: rec.type as AdminRealtimeOrderEvent['type'],
