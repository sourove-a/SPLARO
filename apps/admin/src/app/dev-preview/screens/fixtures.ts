...
/** Two universes for the funnel list, and the catalogue the editor picks from. */
export const funnelUniverses = [
  {
    id: 'fun-1',
    name: 'SPLARO Lifestyle Drop',
    slug: 'lifestyle',
    subdomain: 'lifestyle',
    domain: null,
    isActive: true,
    themePreset: 'imperial-purple',
    themeName: 'Imperial Violet Matrix',
    activeProductId: 'prd-1',
    headline: 'STEP OUT OF THE ORDINARY',
    subheadline: 'Limited Edition Masterpiece Drop · Only 100 Pieces Worldwide',
    ctaText: 'অর্ডার কনফার্ম করুন (ক্যাশ অন ডেলিভারি)',
    bulletPoints: ['100% original fabric', '3-day easy return', 'Cash on delivery'],
    whatsappNumber: '01905010205',
  ...
  },
  {
    ...
    domain: 'eidedit.shop',
    isActive: false,
    themePreset: 'cyber-lime',
    activeProductId: 'prd-2',
...
export const funnelProductPicker = [
  {
    id: 'prd-1',
    name: 'Meherjaan Silk Kaftan',
    description: 'Hand-finished silk kaftan cut for Dhaka summers.',
    schemaMarkup: { nameBn: 'মেহেরজান সিল্ক কাফতান' },
    basePrice: 3450,
    compareAtPrice: 4950,
    status: 'ACTIVE',
    sku: 'SPL-KFT-014',
    productCode: 'KFT014',
    images: [{ url: '/uploads/media/kaftan.webp' }],
    variants: [{ id: 'v1', stock: 12, size: 'M' }],
  },
  {
    id: 'prd-2',
    name: 'Noor Embroidered Abaya',
    description: 'Machine-embroidered abaya with a soft inner lining.',
    schemaMarkup: { nameBn: 'নূর এমব্রয়ডারড আবায়া' },
    basePrice: 5200,
    compareAtPrice: null,
    status: 'ACTIVE',
    sku: 'SPL-ABY-221',
    productCode: 'ABY221',
    images: [{ url: '/uploads/media/abaya.webp' }],
    variants: [{ id: 'v2', stock: 4, size: 'L' }],
  },
]
