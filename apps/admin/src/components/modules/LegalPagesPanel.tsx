  ...
  return (
    <div className="space-y-4">
      <section className="product-create-hero">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[var(--admin-text-secondary)]">
            SPLARO · Content
          </p>
          <h2 className="mt-1 text-2xl font-semibold text-[var(--admin-text)]">Legal & policy pages</h2>
            ...
            <>
              <section className="product-create-section space-y-4">
                ...
                <label className="admin-field block space-y-1.5">
                  <span className="text-xs font-semibold uppercase tracking-wide text-[var(--admin-text-secondary)]">Page title</span>
                  <input
                ...
                <label className="admin-field block space-y-1.5">
                  <span className="text-xs font-semibold uppercase tracking-wide text-[var(--admin-text-secondary)]">Intro / summary</span>
                  <textarea
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <label className="admin-field block space-y-1.5">
                    <span className="text-xs font-semibold uppercase tracking-wide text-[var(--admin-text-secondary)]">SEO title</span>
                    <input
                      className="admin-input admin-input--premium"
                  ...
                  <label className="admin-field block space-y-1.5">
                    <span className="text-xs font-semibold uppercase tracking-wide text-[var(--admin-text-secondary)]">SEO description</span>
                    <input
                      className="admin-input admin-input--premium"
              ...
              <div className="flex flex-wrap gap-2">
                <AdminButton variant="accent" onClick={() => void save()} disabled={saveMutation.isPending || !canEditLegal}>
